...
@testset "Matrices" begin
    ...
    @testset "Matrices Functions" begin
        ...
        @test SchwartzSmith.G(p, 1) ≈ [0.225373 0; 0 1] atol = 1e-4 rtol = 1e-4
        @test SchwartzSmith.c(p, 1) ≈ [0; -0.0125] atol = 1e-4 rtol = 1e-4
        @test SchwartzSmith.d(T, p) ≈ [0.13683; 0.356955] atol = 1e-4 rtol = 1e-4
        @test SchwartzSmith.F(T, p) ≈ [3.38074e-7 1; 1e-8 1] atol = 1e-4 rtol = 1e-4
    end
end
