"""
    sqrt_smoother(T::Matrix{Typ}, sqrt_f::SquareRootFilter{Typ}, p::SSParams{Typ}, delta_t) where Typ

Square Root smoother without exogenous variables.
"""
function sqrt_smoother(T::Matrix{Typ}, sqrt_f::SquareRootFilter{Typ}, p::SSParams{Typ}, delta_t) where Typ
...
"""
    sqrt_smoother(T::Matrix{Typ}, X::Matrix{Typ}, sqrt_f::SquareRootFilter{Typ}, p::SSParams{Typ}, delta_t) where Typ

Square Root smoother for when exogenous variables are included.
"""
function sqrt_smoother(T::Matrix{Typ}, X::Matrix, sqrt_f::SquareRootFilter{Typ}, p::SSParams{Typ}, delta_t) where Typ
    n_exp = size(X, 2)
