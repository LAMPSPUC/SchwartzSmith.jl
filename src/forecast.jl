"""
    forecast(T::Matrix{Typ}, N::Int, p::SSParams{Typ}, f::Filter{Typ}; delta_t = 1) where Typ
...
"""
    forecast(T::Matrix{Typ}, X::VecOrMat, N::Int, p::SSParams{Typ}, f::Filter{Typ}; delta_t = 1) where Typ
